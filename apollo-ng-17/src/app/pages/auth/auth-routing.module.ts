...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'login', loadChildren: () => import('./login/login.module').then(m => m.LoginModule) },  // ✅ Explicitly define login path
        { path: '', redirectTo: 'login', pathMatch: 'full' },  // ✅ Redirect empty auth path to login
